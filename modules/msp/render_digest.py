...
def render_html(data: dict[str, Any]) -> str:
    ...
    parts = [
        ...
        '<tr><td style="background:%s;padding:24px 28px;color:#ffffff;">' % DARK,
        '<div style="font-size:12px;line-height:18px;letter-spacing:0.08em;text-transform:uppercase;opacity:0.85;">GitHub Releases Monitor</div>',
        '<div style="font-size:28px;line-height:36px;font-weight:bold;margin-top:8px;">%s</div>' % subject,
        '<div style="font-size:14px;line-height:22px;opacity:0.92;margin-top:10px;">%s</div>' % _esc(intro),
        '<div style="font-size:12px;line-height:18px;opacity:0.75;margin-top:12px;">Generated: %s</div>' % _esc(timestamp),
        '</td></tr>',
        ...
        'Generated by IMM-Romania MSP GitHub checker. '
        '<a href="https://www.firmade.ai" style="color:%s;text-decoration:none;font-weight:600;margin-left:8px;">www.FirmaDe.AI</a>'
        '</td></tr>' % (MUTED, ACCENT),

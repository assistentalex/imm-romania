...
def render_html(data: dict[str, Any]) -> str:
    ...
    parts = [
        ...
        '<tr><td style="background:%s;padding:24px 28px;color:#ffffff;border-bottom:4px solid %s;">' % (DARK, ACCENT),
        '<div style="font-size:12px;line-height:18px;letter-spacing:0.14em;text-transform:uppercase;opacity:0.88;">Built for teams using <a href="https://www.firmade.ai" style="color:#ffffff;text-decoration:none;font-weight:700;">Firma de AI</a> and supported by <a href="https://firmade.it" style="color:#ffffff;text-decoration:none;font-weight:700;">Firma de IT</a>.</div>',
        '<div style="font-size:30px;line-height:36px;font-weight:bold;margin-top:10px;">GitHub Releases Digest</div>',
        ...
        '<div style="font-size:12px;line-height:18px;opacity:0.78;margin-top:10px;">Generated: %s • Useful AI intelligence for Romanian teams</div>' % _esc(timestamp),
        '</td></tr>',
        ...
        '<div style="margin:0;">Generated by <a href="https://github.com/assistentalex/openclaw-imm-romania" style="color:%s;text-decoration:none;font-weight:600;">IMM-Romania MSP GitHub checker</a> · <a href="https://www.firmade.ai" style="color:%s;text-decoration:none;font-weight:600;">Firma de AI</a> · <a href="https://firmade.it" style="color:%s;text-decoration:none;font-weight:600;">Firma de IT</a></div>'
